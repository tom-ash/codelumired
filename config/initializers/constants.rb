...
SKILLFIND_TECH_NAME = 'soundof.it'
SKILLFIND_TECH_NAME_CONSTANTIZED_NAME = 'SoundofIt'
SKILLFIND_TECH_NAME_APEX_DOMAIN = 'soundof.it'
...
# DEV
SKILLFIND_TECH_DOMAIN_DEV = 'local.soundof.it:8080'
