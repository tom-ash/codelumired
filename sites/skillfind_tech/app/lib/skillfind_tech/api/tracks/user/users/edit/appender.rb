        ...
        module Users
          module Edit
            class Appender < ::SkillfindTech::Api::Tracks::Common::Appender
              ...
              def localizations
                @localizations ||= user_localizations.merge(getLocalizations("sites/skillfind_tech/app/lib/skillfind_tech/api/tracks/user/users/edit/localizations/#{lang}.json"))
              end
