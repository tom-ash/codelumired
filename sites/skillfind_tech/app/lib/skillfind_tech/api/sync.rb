    ...
    class Sync < ::Api::Sync
      helpers do
        def track_paths
          {
            ...
            ::SkillfindTech::Api::Tracks::Visitor::About::Meta::TRACK => ::SkillfindTech::Api::Tracks::Visitor::About::Meta::UNLOCALIZED_PATH,
        ...
        def append_track_data
          ...
          when ::SkillfindTech::Api::Tracks::Visitor::About::Meta::TRACK then ::SkillfindTech::Api::Tracks::Visitor::About::Appender.new(attrs).call
        ...
        def append_links
          ...
          state[:links] = links.merge(
            ...
            ::SkillfindTech::Api::Tracks::Visitor::About::Meta::TRACK => ::SkillfindTech::Api::Tracks::Visitor::About::Linker.new(lang).call,
