  ...
  module AnnouncementModules
    module Description
      ...
      def polish_description
        "#{titleized_category} do wynajęcia #{located_at_district}#{with_area_and_monthly_price}. | warsawlease.pl - ogłoszenia wynajmu nieruchomości w Warszawie."
      end

      def english_description
        "#{titleized_category} for lease #{located_at_district}#{with_area_and_monthly_price}. | warsawlease.pl - real estate lease announcements in Warsaw."
      end
