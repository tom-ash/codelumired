    ...
    module Announcement
      module Index
        class Visitor
          ...
          def initialize(announcements:, lang:, partner_path:)
          ...
          attr_reader :announcements, :lang, :partner_path

          def serialize_announcement(announcement)
            serialized_announcement = announcement.attributes.slice(*ATTRS)
            serialized_announcement['path'] = "#{partner_path}#{announcement.url(lang)}"
