...
RSpec.describe ::Commands::User::Authorize::AccessToken do
  subject { described_class.new(access_token: access_token, constantized_site_name: 'MapawynajmuPl').call }
  ...
  let!(:user) { create(:mapawynajmu_pl_user, encrypted_access_token: encrypted_access_token) }
