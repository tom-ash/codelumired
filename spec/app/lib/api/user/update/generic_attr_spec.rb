...
RSpec.describe ::Api::User::Update::GenericAttr do
  subject { put '/warsawlease/user/update/generic-attr/first_name', params: params, headers: { 'Access-Token': access_token, 'Lang': 'pl' } }
  let!(:user) { create(:warsawlease_user, first_name: first_name) }
