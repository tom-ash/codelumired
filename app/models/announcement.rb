class Announcement < ApplicationRecord
  ...
  validates :rent_amount, presence: true, numericality: { only_integer: true }
  validates :additional_fees, presence: true, inclusion: { in: [true, false] }
  ...
  def self.create_test_announcements
    100.times do
      ...
      @new_announcement = Announcement.create({
        ...
        rent_amount: [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000].shuffle[0],
        additional_fees: [0, 1].shuffle[0],
        pictures: @pictures,
